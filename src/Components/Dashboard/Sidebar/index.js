...
import { MdOutlineKeyboardArrowUp, MdOutlineKeyboardArrowDown, MdOutlineKeyboardDoubleArrowLeft, MdOutlineHome, MdOutlineTv } from "react-icons/md";
    ...
    <div className={styles.sidebar}>
      ...
      <div className={styles.rightPanelSidebar}>
        <div className={styles.sidebarTop}>
          ...
          <MdOutlineKeyboardDoubleArrowLeft className={styles.leftArrow} onClick={toggleRightPanel} />
        </div>
